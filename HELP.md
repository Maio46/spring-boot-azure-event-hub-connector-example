...
* The original package name 'com.example.spring.azure.spring-boot-azure-event-hub-connector-example' is invalid and this project uses 'com.example.spring.azure.spring_boot_azure_event_hub_connector_example' instead.
